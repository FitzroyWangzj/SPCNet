...
class InceptionBottleneck(BaseModule):
    ...
    def __init__(
            ...
            dilations: Sequence[int] = (1, 2, 2, 3),
            expansion: float = 1.0,
            norm_cfg: Optional[dict] = dict(type='BN', momentum=0.03, eps=0.001),
            act_cfg: Optional[dict] = dict(type='SiLU'),
            init_cfg: Optional[dict] = None,
        ...
        self.dw_conv3 = ConvModule(hidden_channels, hidden_channels, kernel_sizes[3], 1,
                                   ...
                                   groups=hidden_channels, norm_cfg=None, act_cfg=None)
        self.pw_conv = ConvModule(4 * hidden_channels, hidden_channels, 1, 1, 0, 1,
                                  norm_cfg=norm_cfg, act_cfg=act_cfg)
...
class MSCStage(BaseModule):
    ...
    def __init__(
        ...
        self.blocks = nn.ModuleList([
            MSCBlock(hidden_channels, hidden_channels, kernel_sizes, dilations, 
                     1.0, ffn_scale, ffn_kernel_size, dropout_rate,
...
class MSCNet(BaseModule):
    ...
    arch_settings = {
        ...
        # shortcut_ffn_scale(11), shortcut_ffn_kernel_size(12), add_identity(13)

        'S': [[32, 64, 3, (3, 3, 3, 3), (1, 2, 2, 3), 0.5, 4.0, 3, 0.1, 1.0, True, 8.0, 5, True],
              [64, 128, 4, (3, 3, 3, 3), (1, 2, 2, 3), 0.5, 4.0, 3, 0.1, 1.0, True, 8.0, 7, True],
              [128, 256, 6, (3, 3, 3, 3), (1, 2, 2, 3), 0.5, 4.0, 3, 0.1, 1.0, True, 4.0, 9, True],
              [256, 512, 3, (3, 3, 3, 3), (1, 2, 2, 3), 0.5, 4.0, 3, 0.1, 1.0, True, 4.0, 11, True]],
    }
    ...
    def __init__(
        ...
        for i, (in_channels, out_channels, num_blocks, kernel_sizes, dilations, expansion, ffn_scale, ffn_kernel_size,
                ...
                add_identity) in enumerate(arch_setting):
            stage = MSCStage(in_channels, out_channels, num_blocks, kernel_sizes, dilations, expansion,
