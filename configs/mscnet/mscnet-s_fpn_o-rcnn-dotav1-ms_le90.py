_base_ = [
    '../_base_/default_runtime.py', '../_base_/schedules/schedule_60e.py',
    '../_base_/datasets/dotav1_ms1024.py'
]
...
save_interval = 1
val_interval = 3
max_keep_ckpts = 30  # TODO change

# base_batch_size = (8 GPUs) x (2 samples per GPU)
auto_scale_lr = dict(base_batch_size=16, enable=False)

checkpoint = 'pretrain/epoch_100.pth'  # pretrain # noqa
load_from = 'work_dirs/mscnet-s_fpn_o-rcnn-dotav1-ss_le90_ss/best_mAP_epoch_27.pth'  # resume # noqa
...
# batch_size = (8 GPUs) x (2 samples per GPU) = 16
data = dict(
    samples_per_gpu=bs,
